    ...
    var body: some View {
        ...
        .sheet(isPresented: $isPickerPresented) {
            ...
            VStack(spacing: 16) {
                ...
                HStack {
                    CurrencyPicker(currency: $viewModel.topCurrency, onChange: { _ 
                        in didChangeTopCurrency() })
                    CurrencyPicker(currency: $viewModel.bottomCurrency, onChange: { _
                        in didChangeBottomCurrency() })
                }
            }
